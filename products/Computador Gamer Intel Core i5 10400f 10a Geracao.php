<?php session_start();?>
		...
		<html>
		 <head>
		 	<title>Computador Gamer Intel Core i5 10400f 10a Geracao</title>
   ...
   <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
		 ...
		 <body>
		  <?php require_once('../php/nav.php');?>
			...
			<div id='container-item'>
				<div id='div-img-left'>
					<div id='div-extra-imgs'>
						<img src='../imgsextra/99060b8d87810b4fb11f8fd00432062b.png' class='extra-imgs' id='imgextra0' onclick='iimgextra1()'><br>
						<img src='../imgsextra/a5a4e9834826ad2434162481927e7045.jpg' class='extra-imgs' id='imgextra1' onclick='iimgextra2()'><br>
						<img src='../imgsextra/d53f86654b69facef6bd7cb8c4961df8.jpg' class='extra-imgs' id='imgextra2' onclick='iimgextra3()'><br>
						<img src='../imgsextra/f1740d70f7c8307a42b3f6b45d6e1667.jpg' class='extra-imgs' id='imgextra3' onclick='iimgextra4()'>
					</div>
					<img src='../upload/2a8282b5cb16433b222a13a10b4689ea.jpg' id='img-left'>
				</div>
				<div id='div-infos-product'>
					<b id='title'>Computador Gamer Intel Core i5 10400f 10a Geracao</b><br>
					<div id='evaluation' style='position: relative; height: 1.3vw;'>
						...
						<?php
											...
											$_selectAll = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Computador Gamer Intel Core i5 10400f 10a Geracao'");
											$_selectAll->execute();
	 				 ...
	 				 <b id='price'><h2 style='color: gray; text-decoration: line-through; font-size: 20px;'>R$ 10.900,00</h2><h2 id='price-real-confirm'> R$ 9.374,00</h2><b style='font-size: 18px;'>Ou 25x de R$ 374,96</b><br></b><br>
	 				  
					<form method='post' action='../inserts/insertCarrinho?np=<?php echo 'Computador Gamer Intel Core i5 10400f 10a Geracao';?>'>
			...
			<div id='desc-prod'>
				...
				<div id='alig-desc'>Computador Gamer Intel Core i5 10400f 10a Geracao </div>
			</div><br><br>
			...
			<div id='features-prod-b'><b>Características Gerais</b></div><br>
				...
				<?php
						...
						if('Computador' == 'Console'){
						
						$_sql = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Computador Gamer Intel Core i5 10400f 10a Geracao'");
						$_sql->execute();
	...
	<?php }?>
    	...
    	<?php 
						$_getAval = $_pdo->prepare("SELECT * FROM avalia_prods WHERE prod_aval = 'Computador Gamer Intel Core i5 10400f 10a Geracao'");
						$_getAval->execute();
						$_getAvalFetch = $_getAval->fetchAll(PDO::FETCH_ASSOC);

							$_getAvalAverage = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Computador Gamer Intel Core i5 10400f 10a Geracao'");

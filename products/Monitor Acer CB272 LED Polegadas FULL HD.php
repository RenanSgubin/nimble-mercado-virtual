<?php session_start();?>
		...
		<html>
		 <head>
		 	<title>Monitor Acer CB272 LED Polegadas FULL HD</title>
   ...
   <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
		 ...
		 <body>
		  <?php require_once('../php/nav.php');?>
			...
			<div id='container-item'>
				<div id='div-img-left'>
					<div id='div-extra-imgs'>
						<img src='../imgsextra/7ca708433499ab4e206b0c770373840b.png' class='extra-imgs' id='imgextra0' onclick='iimgextra1()'><br>
						<img src='../imgsextra/c872c1e9afd97148bd504b07aca59cdc.png' class='extra-imgs' id='imgextra1' onclick='iimgextra2()'><br>
						<img src='../imgsextra/a136311219a42ed3cfe8162a46bc5428.jpg' class='extra-imgs' id='imgextra2' onclick='iimgextra3()'><br>
						<img src='../imgsextra/3ede141c42ea1119e3f74e53874599c5.jpg' class='extra-imgs' id='imgextra3' onclick='iimgextra4()'>
					</div>
					<img src='../upload/1fc427124e43b5606811e07bf4001002.jpg' id='img-left'>
				</div>
				<div id='div-infos-product'>
					<b id='title'>Monitor Acer CB272 LED Polegadas FULL HD</b><br>
					<div id='evaluation' style='position: relative; height: 1.3vw;'>
						...
						<?php
											...
											$_selectAll = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Monitor Acer CB272 LED Polegadas FULL HD'");
											$_selectAll->execute();
	 				 ...
	 				 <b id='price'><h2 style='color: gray; text-decoration: line-through; font-size: 20px;'>R$ 2.100,00</h2><h2 id='price-real-confirm'> R$ 1.869,00</h2><b style='font-size: 18px;'>Ou 5x de R$ 373,80</b><br></b><br>
	 				  
					<form method='post' action='../inserts/insertCarrinho?np=<?php echo 'Monitor Acer CB272 LED Polegadas FULL HD';?>'>
			...
			<div id='desc-prod'>
				...
				<div id='alig-desc'>Monitor Acer CB272 LED Polegadas FULL HD </div>
			</div><br><br>
			...
			<div id='features-prod-b'><b>Características Gerais</b></div><br>
				...
				<?php
						...
						$_sql = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Monitor Acer CB272 LED Polegadas FULL HD'");
						$_sql->execute();
	...
	<?php }?>
    	...
    	<?php 
						$_getAval = $_pdo->prepare("SELECT * FROM avalia_prods WHERE prod_aval = 'Monitor Acer CB272 LED Polegadas FULL HD'");
						$_getAval->execute();
						$_getAvalFetch = $_getAval->fetchAll(PDO::FETCH_ASSOC);

							$_getAvalAverage = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Monitor Acer CB272 LED Polegadas FULL HD'");

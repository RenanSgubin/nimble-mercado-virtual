<?php session_start();?>
		...
		<html>
		 <head>
		 	<title>Xbox Series X 1 TB SSD Preto Blu Ray 4K</title>
   ...
   <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
		 ...
		 <body>
		  <?php require_once('../php/nav.php');?>
			...
			<div id='container-item'>
				<div id='div-img-left'>
					<div id='div-extra-imgs'>
						<img src='../imgsextra/4d89f03e4ce0b1652ba51c29b8444380.png' class='extra-imgs' id='imgextra0' onclick='iimgextra1()'><br>
						<img src='../imgsextra/84c4c8edb23e3b8cd3247df6a6d9145b.png' class='extra-imgs' id='imgextra1' onclick='iimgextra2()'><br>
						<img src='../imgsextra/64321ab37bc6ba1efe14680d1107afbf.jpg' class='extra-imgs' id='imgextra2' onclick='iimgextra3()'><br>
						<img src='../imgsextra/0ed768ac694ed0350447f2fb36c1075b.jpg' class='extra-imgs' id='imgextra3' onclick='iimgextra4()'>
					</div>
					<img src='../upload/30f750c72c938ca4c60f7ccd578c8611.jpg' id='img-left'>
				</div>
				<div id='div-infos-product'>
					<b id='title'>Xbox Series X 1 TB SSD Preto Blu Ray 4K</b><br>
					<div id='evaluation' style='position: relative; height: 1.3vw;'>
						...
						<?php
											...
											$_selectAll = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Xbox Series X 1 TB SSD Preto Blu Ray 4K'");
											$_selectAll->execute();
	 				 ...
	 				 <b id='price'><h2 style='color: gray; text-decoration: line-through; font-size: 20px;'>R$ 4.900,00</h2><h2 id='price-real-confirm'> R$ 4.361,00</h2><b style='font-size: 18px;'>Ou 15x de R$ 290,73</b><br></b><br>
	 				  
					<form method='post' action='../inserts/insertCarrinho?np=<?php echo 'Xbox Series X 1 TB SSD Preto Blu Ray 4K';?>'>
			...
			<div id='desc-prod'>
				...
				<div id='alig-desc'>Xbox Series X 1 TB SSD Preto Blu Ray 4K </div>
			</div><br><br>
			...
			<div id='features-prod-b'><b>Características Gerais</b></div><br>
				...
				<?php
						...
						$_sql = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Xbox Series X 1 TB SSD Preto Blu Ray 4K'");
						$_sql->execute();
	...
	<?php }?>
    	...
    	<?php 
						$_getAval = $_pdo->prepare("SELECT * FROM avalia_prods WHERE prod_aval = 'Xbox Series X 1 TB SSD Preto Blu Ray 4K'");
						$_getAval->execute();
						$_getAvalFetch = $_getAval->fetchAll(PDO::FETCH_ASSOC);

							$_getAvalAverage = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Xbox Series X 1 TB SSD Preto Blu Ray 4K'");

<?php session_start();?>
		...
		<html>
		 <head>
		 	<title>Notebook Samsung Flash F30 Intel Celeron 4GB</title>
   ...
   <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
		 ...
		 <body>
		  <?php require_once('../php/nav.php');?>
			...
			<div id='container-item'>
				<div id='div-img-left'>
					<div id='div-extra-imgs'>
						<img src='../imgsextra/19133a5eb9953268fb54dc7e0f16788d.jpg' class='extra-imgs' id='imgextra0' onclick='iimgextra1()'><br>
						<img src='../imgsextra/ba70d7610ddcf952651c946f645e0a80.png' class='extra-imgs' id='imgextra1' onclick='iimgextra2()'><br>
						<img src='../imgsextra/ba25514a5b5ca389ef28abb2fb5d7e47.jpg' class='extra-imgs' id='imgextra2' onclick='iimgextra3()'><br>
						<img src='../imgsextra/5e40c307ce5621c6270966a3b32453c6.jpg' class='extra-imgs' id='imgextra3' onclick='iimgextra4()'>
					</div>
					<img src='../upload/13b56ad8879006b0aa478ee4b3e1319a.jpg' id='img-left'>
				</div>
				<div id='div-infos-product'>
					<b id='title'>Notebook Samsung Flash F30 Intel Celeron 4GB</b><br>
					<div id='evaluation' style='position: relative; height: 1.3vw;'>
						...
						<?php
											...
											$_selectAll = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Notebook Samsung Flash F30 Intel Celeron 4GB'");
											$_selectAll->execute();
	 				 ...
	 				 <b id='price'>R$ 2564<br><b style='font-size: 17px;'>Ou 10x de R$ 256,40</b><br></b><br>
	 				  
					<form method='post' action='../inserts/insertCarrinho?np=<?php echo 'Notebook Samsung Flash F30 Intel Celeron 4GB';?>'>
			...
			<div id='desc-prod'>
				...
				<div id='alig-desc'>Notebook Samsung Flash F30 Intel Celeron 4GB </div>
			</div><br><br>
			...
			<div id='features-prod-b'><b>Características Gerais</b></div><br>
				...
				<?php
						...
						$_sql = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Notebook Samsung Flash F30 Intel Celeron 4GB'");
						$_sql->execute();
	...
	<?php }?>
    	...
    	<?php 
						$_getAval = $_pdo->prepare("SELECT * FROM avalia_prods WHERE prod_aval = 'Notebook Samsung Flash F30 Intel Celeron 4GB'");
						$_getAval->execute();
						$_getAvalFetch = $_getAval->fetchAll(PDO::FETCH_ASSOC);

							$_getAvalAverage = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Notebook Samsung Flash F30 Intel Celeron 4GB'");

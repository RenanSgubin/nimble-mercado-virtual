<?php session_start();?>
		...
		<html>
		 <head>
		 	<title>Cadeira Gamer PCTop Power Reclinavel Preta e Azul</title>
   ...
   <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
		 ...
		 <body>
		  <?php require_once('../php/nav.php');?>
			...
			<div id='container-item'>
				<div id='div-img-left'>
					<div id='div-extra-imgs'>
						<img src='../imgsextra/5ba758e89324cad7b3e5cbfe41a1d1dc.png' class='extra-imgs' id='imgextra0' onclick='iimgextra1()'><br>
						<img src='../imgsextra/980b656bbe9c471adf97d817a3040e6e.png' class='extra-imgs' id='imgextra1' onclick='iimgextra2()'><br>
						<img src='../imgsextra/dff1e146f756c6e87ec26b10e92f329f.jpg' class='extra-imgs' id='imgextra2' onclick='iimgextra3()'><br>
						<img src='../imgsextra/6ac3a6a0c7dcb28da1076c6ea4c88cf1.jpg' class='extra-imgs' id='imgextra3' onclick='iimgextra4()'>
					</div>
					<img src='../upload/438b0377e0a594af5852ab39ea8b1db4.png' id='img-left'>
				</div>
				<div id='div-infos-product'>
					<b id='title'>Cadeira Gamer PCTop Power Reclinavel Preta e Azul</b><br>
					<div id='evaluation' style='position: relative; height: 1.3vw;'>
						...
						<?php
											...
											$_selectAll = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Cadeira Gamer PCTop Power Reclinavel Preta e Azul'");
											$_selectAll->execute();
	 				 ...
	 				 <b id='price'><h2 style='color: gray; text-decoration: line-through; font-size: 20px;'>R$ 1.930,00</h2><h2 id='price-real-confirm'> R$ 1.466,80</h2><b style='font-size: 18px;'>Ou 5x de R$ 293,36</b><br></b><br>
	 				  
					<form method='post' action='../inserts/insertCarrinho?np=<?php echo 'Cadeira Gamer PCTop Power Reclinavel Preta e Azul';?>'>
			...
			<div id='desc-prod'>
				...
				<div id='alig-desc'>Cadeira Gamer PCTop Power Reclinavel Preta e Azul </div>
			</div><br><br>
			...
			<div id='features-prod-b'><b>Características Gerais</b></div><br>
				...
				<?php
						...
						$_sql = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Cadeira Gamer PCTop Power Reclinavel Preta e Azul'");
						$_sql->execute();
	...
	<?php }?>
    	...
    	<?php 
						$_getAval = $_pdo->prepare("SELECT * FROM avalia_prods WHERE prod_aval = 'Cadeira Gamer PCTop Power Reclinavel Preta e Azul'");
						$_getAval->execute();
						$_getAvalFetch = $_getAval->fetchAll(PDO::FETCH_ASSOC);

							$_getAvalAverage = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Cadeira Gamer PCTop Power Reclinavel Preta e Azul'");

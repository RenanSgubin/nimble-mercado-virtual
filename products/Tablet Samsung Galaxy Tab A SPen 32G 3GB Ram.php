<?php session_start();?>
		...
		<html>
		 <head>
		 	<title>Tablet Samsung Galaxy Tab A SPen 32G 3GB Ram</title>
   ...
   <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
		  ...
		  <?php require_once('../php/nav.php');?>
			...
			<div id='container-item'>
				<div id='div-img-left'>
					<div id='div-extra-imgs'>
						<img src='../imgsextra/a79432578c1324a2555c7d8ce1469be6.png' class='extra-imgs' id='imgextra0' onclick='iimgextra1()'><br>
						<img src='../imgsextra/ebd40148fdad8b725ef9b93aa65b483c.png' class='extra-imgs' id='imgextra1' onclick='iimgextra2()'><br>
						<img src='../imgsextra/fa2bcd62106001060d791320fdf029d2.jpg' class='extra-imgs' id='imgextra2' onclick='iimgextra3()'><br>
						<img src='../imgsextra/687deb95d2187b5689a96ccc4dce83d9.jpg' class='extra-imgs' id='imgextra3' onclick='iimgextra4()'>
					</div>
					<img src='../upload/7cf6830abfffc7004c0a604b7d7fc42e.jpg' id='img-left'>
				</div>
				<div id='div-infos-product'>
					<b id='title'>Tablet Samsung Galaxy Tab A SPen 32G 3GB Ram</b><br>
					<div id='evaluation' style='position: relative; height: 1.3vw;'>
						...
						<?php
											...
											$_selectAll = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Tablet Samsung Galaxy Tab A SPen 32G 3GB Ram'");
											$_selectAll->execute();
	 				 ...
	 				 <b id='price'>R$ 2200<br><b style='font-size: 17px;'>Ou 5x de R$ 440,00</b><br></b><br>
	 				  
					<form method='post' action='../inserts/insertCarrinho?np=<?php echo 'Tablet Samsung Galaxy Tab A SPen 32G 3GB Ram';?>'>
			...
			<div id='features-prod-b'><b>Características Gerais</b></div><br>
				...
				<?php
						...
						$_sql = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Tablet Samsung Galaxy Tab A SPen 32G 3GB Ram'");
						$_sql->execute();
	...
	<?php }?>
    	...
    	<?php 
						$_getAval = $_pdo->prepare("SELECT * FROM avalia_prods WHERE prod_aval = 'Tablet Samsung Galaxy Tab A SPen 32G 3GB Ram'");
						$_getAval->execute();
						$_getAvalFetch = $_getAval->fetchAll(PDO::FETCH_ASSOC);

							$_getAvalAverage = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Tablet Samsung Galaxy Tab A SPen 32G 3GB Ram'");

<?php session_start();?>
		...
		<html>
		 <head>
		 	<title>pc-gamer-completo-facil-intel-i5-3470s</title>
   ...
   <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
		 ...
		 <body>
		  <?php require_once('../php/nav.php');?>
			...
			<div id='container-item'>
				<div id='div-img-left'>
					<div id='div-extra-imgs'>
						<img src='../imgsextra/3dda68bcf5b350d35b8ce3de4fd70525.jpg' class='extra-imgs' id='imgextra0' onclick='iimgextra1()'><br>
						<img src='../imgsextra/12509e13acf8bbba7e3714f7e1a3d856.png' class='extra-imgs' id='imgextra1' onclick='iimgextra2()'><br>
						<img src='../imgsextra/f3e6b4b4c836903f2a043def8d616f7f.jpg' class='extra-imgs' id='imgextra2' onclick='iimgextra3()'><br>
						<img src='../imgsextra/3d0ee509c4e42c193065635cd6712db3.jpg' class='extra-imgs' id='imgextra3' onclick='iimgextra4()'>
					</div>
					<img src='../upload/37776300f56d532a39ba67c27bb096ce.jpg' id='img-left'>
				</div>
				<div id='div-infos-product'>
					<b id='title'>pc-gamer-completo-facil-intel-i5-3470s</b><br>
					<div id='evaluation' style='position: relative; height: 1.3vw;'>
						...
						<?php
											...
											$_selectAll = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'pc-gamer-completo-facil-intel-i5-3470s'");
											$_selectAll->execute();
	 				 ...
	 				 <b id='price'>R$ 3017<br><b style='font-size: 17px;'>Ou 10x de R$ 301,70</b><br></b><br>
	 				  
					<form method='post' action='../inserts/insertCarrinho?np=<?php echo 'pc-gamer-completo-facil-intel-i5-3470s';?>'>
			...
			<div id='desc-prod'>
				...
				<div id='alig-desc'>pc-gamer-completo-facil-intel-i5-3470s </div>
			</div><br><br>
			...
			<div id='features-prod-b'><b>Características Gerais</b></div><br>
				...
				<?php
						...
						$_sql = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'pc-gamer-completo-facil-intel-i5-3470s'");
						$_sql->execute();
	...
	<?php }?>
    	...
    	<?php 
						$_getAval = $_pdo->prepare("SELECT * FROM avalia_prods WHERE prod_aval = 'pc-gamer-completo-facil-intel-i5-3470s'");
						$_getAval->execute();
						$_getAvalFetch = $_getAval->fetchAll(PDO::FETCH_ASSOC);

							$_getAvalAverage = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'pc-gamer-completo-facil-intel-i5-3470s'");

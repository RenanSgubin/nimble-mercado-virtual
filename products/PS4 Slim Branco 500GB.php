<?php session_start();?>
		...
		<html>
		 <head>
		 	<title>PS4 Slim Branco 500GB</title>
   ...
   <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
		 ...
		 <body>
		  <?php require_once('../php/nav.php');?>
			...
			<div id='container-item'>
				<div id='div-img-left'>
					<div id='div-extra-imgs'>
						<img src='../imgsextra/192da75b17530e052c35b0d9fc0e53a2.png' class='extra-imgs' id='imgextra0' onclick='iimgextra1()'><br>
						<img src='../imgsextra/0b08395b3ea6225091255f642915fe26.png' class='extra-imgs' id='imgextra1' onclick='iimgextra2()'><br>
						<img src='../imgsextra/50a7392ede0f09313673dadc7f0ab026.jpg' class='extra-imgs' id='imgextra2' onclick='iimgextra3()'><br>
						<img src='../imgsextra/e4f2ce7f45136145a684ff592c0aa9d6.jpg' class='extra-imgs' id='imgextra3' onclick='iimgextra4()'>
					</div>
					<img src='../upload/d52b67e6f5df733f296bee43fe8696a8.jpg' id='img-left'>
				</div>
				<div id='div-infos-product'>
					<b id='title'>PS4 Slim Branco 500GB</b><br>
					<div id='evaluation' style='position: relative; height: 1.3vw;'>
						...
						<?php
											...
											$_selectAll = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'PS4 Slim Branco 500GB'");
											$_selectAll->execute();
	 				 ...
	 				 <b id='price'>R$ 3900<br><b style='font-size: 17px;'>Ou 10x de R$ 390,00</b><br></b><br>
	 				  
					<form method='post' action='../inserts/insertCarrinho?np=<?php echo 'PS4 Slim Branco 500GB';?>'>
			...
			<div id='desc-prod'>
				...
				<div id='alig-desc'>PS4 Slim Branco 500GB </div>
			</div><br><br>
			...
			<div id='features-prod-b'><b>Características Gerais</b></div><br>
				...
				<?php
						...
						$_sql = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'PS4 Slim Branco 500GB'");
						$_sql->execute();
	...
	<?php }?>
    	...
    	<?php 
						$_getAval = $_pdo->prepare("SELECT * FROM avalia_prods WHERE prod_aval = 'PS4 Slim Branco 500GB'");
						$_getAval->execute();
						$_getAvalFetch = $_getAval->fetchAll(PDO::FETCH_ASSOC);

							$_getAvalAverage = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'PS4 Slim Branco 500GB'");

<?php session_start();?>
		...
		<html>
		 <head>
		 	<title>Monitor Led 23,6 Polegadas Widescreen 24B1H Aoc</title>
   ...
   <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
		 ...
		 <body>
		  <?php require_once('../php/nav.php');?>
			...
			<div id='container-item'>
				<div id='div-img-left'>
					<div id='div-extra-imgs'>
						<img src='../imgsextra/68dc737bfbf45c753b9938f7078753a4.png' class='extra-imgs' id='imgextra0' onclick='iimgextra1()'><br>
						<img src='../imgsextra/8b7e44505565dac39c2dc69fbcff79a9.png' class='extra-imgs' id='imgextra1' onclick='iimgextra2()'><br>
						<img src='../imgsextra/2c0d0b2581fbedaec916199180f8a756.jpg' class='extra-imgs' id='imgextra2' onclick='iimgextra3()'><br>
						<img src='../imgsextra/309c1330418bb0b940fb265d9699e7f7.jpg' class='extra-imgs' id='imgextra3' onclick='iimgextra4()'>
					</div>
					<img src='../upload/4a7ac9ae6d294b612ff98f3a0f7f47af.jpg' id='img-left'>
				</div>
				<div id='div-infos-product'>
					<b id='title'>Monitor Led 23,6 Polegadas Widescreen 24B1H Aoc</b><br>
					<div id='evaluation' style='position: relative; height: 1.3vw;'>
						...
						<?php
											...
											$_selectAll = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Monitor Led 23,6 Polegadas Widescreen 24B1H Aoc'");
											$_selectAll->execute();
	 				 ...
	 				 <b id='price'><h2 style='color: gray; text-decoration: line-through; font-size: 20px;'>R$ 2.400,00</h2><h2 id='price-real-confirm'> R$ 2.136,00</h2><b style='font-size: 18px;'>Ou 5x de R$ 427,20</b><br></b><br>
	 				  
					<form method='post' action='../inserts/insertCarrinho?np=<?php echo 'Monitor Led 23,6 Polegadas Widescreen 24B1H Aoc';?>'>
			...
			<div id='desc-prod'>
				...
				<div id='alig-desc'>Monitor Led 23,6 Polegadas Widescreen 24B1H Aoc </div>
			</div><br><br>
			...
			<div id='features-prod-b'><b>Características Gerais</b></div><br>
				...
				<?php
						...
						$_sql = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Monitor Led 23,6 Polegadas Widescreen 24B1H Aoc'");
						$_sql->execute();
	...
	<?php }?>
    	...
    	<?php 
						$_getAval = $_pdo->prepare("SELECT * FROM avalia_prods WHERE prod_aval = 'Monitor Led 23,6 Polegadas Widescreen 24B1H Aoc'");
						$_getAval->execute();
						$_getAvalFetch = $_getAval->fetchAll(PDO::FETCH_ASSOC);

							$_getAvalAverage = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Monitor Led 23,6 Polegadas Widescreen 24B1H Aoc'");

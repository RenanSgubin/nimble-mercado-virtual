<?php session_start();?>
		...
		<html>
		 <head>
		 	<title>Notebook Positivo Motion Q Q464C Intel Atom Quadcore</title>
   ...
   <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
		 ...
		 <body>
		  <?php require_once('../php/nav.php');?>
			...
			<div id='container-item'>
				<div id='div-img-left'>
					<div id='div-extra-imgs'>
						<img src='../imgsextra/f91f9a52e85f68f90b6f64122548f0e4.jpg' class='extra-imgs' id='imgextra0' onclick='iimgextra1()'><br>
						<img src='../imgsextra/aec820c1fb2fe2c45af514d64bcec493.png' class='extra-imgs' id='imgextra1' onclick='iimgextra2()'><br>
						<img src='../imgsextra/cc12a5ade32fd52f678a263249d319ad.jpg' class='extra-imgs' id='imgextra2' onclick='iimgextra3()'><br>
						<img src='../imgsextra/6e952dfabd308326e0cae9e3df3debd4.jpg' class='extra-imgs' id='imgextra3' onclick='iimgextra4()'>
					</div>
					<img src='../upload/1ecf9db9cca62405fd420ec81f6d2f48.jpg' id='img-left'>
				</div>
				<div id='div-infos-product'>
					<b id='title'>Notebook Positivo Motion Q Q464C Intel Atom Quadcore</b><br>
					<div id='evaluation' style='position: relative; height: 1.3vw;'>
						...
						<?php
											...
											$_selectAll = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Notebook Positivo Motion Q Q464C Intel Atom Quadcore'");
											$_selectAll->execute();
	 				 ...
	 				 <b id='price'>R$ 2229<br><b style='font-size: 17px;'>Ou 5x de R$ 445,80</b><br></b><br>
	 				  
					<form method='post' action='../inserts/insertCarrinho?np=<?php echo 'Notebook Positivo Motion Q Q464C Intel Atom Quadcore';?>'>
			...
			<div id='desc-prod'>
				...
				<div id='alig-desc'>Notebook Positivo Motion Q Q464C Intel Atom Quadcore </div>
			</div><br><br>
			...
			<div id='features-prod-b'><b>Características Gerais</b></div><br>
				...
				<?php
						...
						$_sql = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Notebook Positivo Motion Q Q464C Intel Atom Quadcore'");
						$_sql->execute();
	...
	<?php }?>
    	...
    	<?php 
						$_getAval = $_pdo->prepare("SELECT * FROM avalia_prods WHERE prod_aval = 'Notebook Positivo Motion Q Q464C Intel Atom Quadcore'");
						$_getAval->execute();
						$_getAvalFetch = $_getAval->fetchAll(PDO::FETCH_ASSOC);

							$_getAvalAverage = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Notebook Positivo Motion Q Q464C Intel Atom Quadcore'");

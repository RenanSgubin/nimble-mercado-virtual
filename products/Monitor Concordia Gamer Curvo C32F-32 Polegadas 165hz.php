<?php session_start();?>
		...
		<html>
		 <head>
		 	<title>Monitor Concordia Gamer Curvo C32F-32 Polegadas 165hz</title>
   ...
   <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
		 ...
		 <body>
		  <?php require_once('../php/nav.php');?>
			...
			<div id='container-item'>
				<div id='div-img-left'>
					<div id='div-extra-imgs'>
						<img src='../imgsextra/b52a84b9719fa350de17459355935756.jpg' class='extra-imgs' id='imgextra0' onclick='iimgextra1()'><br>
						<img src='../imgsextra/1a2cb50616620e1eebf65c079847a593.png' class='extra-imgs' id='imgextra1' onclick='iimgextra2()'><br>
						<img src='../imgsextra/243572755f7812960b4ee8c999190266.jpg' class='extra-imgs' id='imgextra2' onclick='iimgextra3()'><br>
						<img src='../imgsextra/9fc646d10cd0f7936a27f6be5a9ce9a8.jpg' class='extra-imgs' id='imgextra3' onclick='iimgextra4()'>
					</div>
					<img src='../upload/4162436503422cb5cd1b1fb499d8bcda.png' id='img-left'>
				</div>
				<div id='div-infos-product'>
					<b id='title'>Monitor Concordia Gamer Curvo C32F-32 Polegadas 165hz</b><br>
					<div id='evaluation' style='position: relative; height: 1.3vw;'>
						...
						<?php
											...
											$_selectAll = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Monitor Concordia Gamer Curvo C32F-32 Polegadas 165hz'");
											$_selectAll->execute();
	 				 ...
	 				 <b id='price'>R$ 1937<br><b style='font-size: 17px;'>Ou 5x de R$ 387,40</b><br></b><br>
	 				  
					<form method='post' action='../inserts/insertCarrinho?np=<?php echo 'Monitor Concordia Gamer Curvo C32F-32 Polegadas 165hz';?>'>
			...
			<div id='desc-prod'>
				...
				<div id='alig-desc'>Monitor Concordia Gamer Curvo C32F-32 Polegadas 165hz </div>
			</div><br><br>
			...
			<div id='features-prod-b'><b>Características Gerais</b></div><br>
				...
				<?php
						...
						$_sql = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Monitor Concordia Gamer Curvo C32F-32 Polegadas 165hz'");
						$_sql->execute();
	...
	<?php }?>
    	...
    	<?php 
						$_getAval = $_pdo->prepare("SELECT * FROM avalia_prods WHERE prod_aval = 'Monitor Concordia Gamer Curvo C32F-32 Polegadas 165hz'");
						$_getAval->execute();
						$_getAvalFetch = $_getAval->fetchAll(PDO::FETCH_ASSOC);

							$_getAvalAverage = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Monitor Concordia Gamer Curvo C32F-32 Polegadas 165hz'");

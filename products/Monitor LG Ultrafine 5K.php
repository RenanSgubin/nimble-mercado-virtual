<?php session_start();?>
		...
		<html>
		 <head>
		 	<title>Monitor LG Ultrafine 5K</title>
   ...
   <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
		 ...
		 <body>
		  <?php require_once('../php/nav.php');?>
			...
			<div id='container-item'>
				<div id='div-img-left'>
					<div id='div-extra-imgs'>
						<img src='../imgsextra/a32ce09d5915157ef36fd8466a08cdc2.jpg' class='extra-imgs' id='imgextra0' onclick='iimgextra1()'><br>
						<img src='../imgsextra/d33d8a805d9d26a59099c9935f422335.png' class='extra-imgs' id='imgextra1' onclick='iimgextra2()'><br>
						<img src='../imgsextra/fd6d11189aaebecc6339628f286924b9.jpg' class='extra-imgs' id='imgextra2' onclick='iimgextra3()'><br>
						<img src='../imgsextra/4222659665f80b8a0de1fa284fbf3556.jpg' class='extra-imgs' id='imgextra3' onclick='iimgextra4()'>
					</div>
					<img src='../upload/e14cfad7577b3007a2563e4eefa334ec.jpg' id='img-left'>
				</div>
				<div id='div-infos-product'>
					<b id='title'>Monitor LG Ultrafine 5K</b><br>
					<div id='evaluation' style='position: relative; height: 1.3vw;'>
						...
						<?php
											...
											$_selectAll = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Monitor LG Ultrafine 5K'");
											$_selectAll->execute();
	 				 ...
	 				 <b id='price'>R$ 14999<br><b style='font-size: 17px;'>Ou 35x de R$ 499,97</b><br></b><br>
	 				  
					<form method='post' action='../inserts/insertCarrinho?np=<?php echo 'Monitor LG Ultrafine 5K';?>'>
			...
			<div id='desc-prod'>
				...
				<div id='alig-desc'>Monitor LG Ultrafine 5K </div>
			</div><br><br>
			...
			<div id='features-prod-b'><b>Características Gerais</b></div><br>
				...
				<?php
						...
						$_sql = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Monitor LG Ultrafine 5K'");
						$_sql->execute();
	...
	<?php }?>
    	...
    	<?php 
						$_getAval = $_pdo->prepare("SELECT * FROM avalia_prods WHERE prod_aval = 'Monitor LG Ultrafine 5K'");
						$_getAval->execute();
						$_getAvalFetch = $_getAval->fetchAll(PDO::FETCH_ASSOC);

							$_getAvalAverage = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Monitor LG Ultrafine 5K'");

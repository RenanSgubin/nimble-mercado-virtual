<?php session_start();?>
		...
		<html>
		 <head>
		 	<title>Cadeira Gamer Black Hawk Elg Preta e Vermelha</title>
   ...
   <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
		 ...
		 <body>
		  <?php require_once('../php/nav.php');?>
			...
			<div id='container-item'>
				<div id='div-img-left'>
					<div id='div-extra-imgs'>
						<img src='../imgsextra/d70faca3453f18fd8eb336dfbcab2f77.png' class='extra-imgs' id='imgextra0' onclick='iimgextra1()'><br>
						<img src='../imgsextra/8d66ea624725b878d77bd5e5944651df.png' class='extra-imgs' id='imgextra1' onclick='iimgextra2()'><br>
						<img src='../imgsextra/d098fa71f00282dead136686e68d758c.jpg' class='extra-imgs' id='imgextra2' onclick='iimgextra3()'><br>
						<img src='../imgsextra/a365b2dd316336030f49a6cd28190179.jpg' class='extra-imgs' id='imgextra3' onclick='iimgextra4()'>
					</div>
					<img src='../upload/cbd4f85d2e8c59c81ac7275cf2e82ea7.png' id='img-left'>
				</div>
				<div id='div-infos-product'>
					<b id='title'>Cadeira Gamer Black Hawk Elg Preta e Vermelha</b><br>
					<div id='evaluation' style='position: relative; height: 1.3vw;'>
						...
						<?php
											...
											$_selectAll = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Cadeira Gamer Black Hawk Elg Preta e Vermelha'");
											$_selectAll->execute();
	 				 ...
	 				 <b id='price'><h2 style='color: gray; text-decoration: line-through; font-size: 20px;'>R$ 1.450,00</h2><h2 id='price-real-confirm'> R$ 1.174,50</h2><b style='font-size: 18px;'>Ou 5x de R$ 234,90</b><br></b><br>
	 				  
					<form method='post' action='../inserts/insertCarrinho?np=<?php echo 'Cadeira Gamer Black Hawk Elg Preta e Vermelha';?>'>
			...
			<div id='desc-prod'>
				...
				<div id='alig-desc'>Cadeira Gamer Black Hawk Elg Preta e Vermelha </div>
			</div><br><br>
			...
			<div id='features-prod-b'><b>Características Gerais</b></div><br>
				...
				<?php
						...
						$_sql = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Cadeira Gamer Black Hawk Elg Preta e Vermelha'");
						$_sql->execute();
	...
	<?php }?>
    	...
    	<?php 
						$_getAval = $_pdo->prepare("SELECT * FROM avalia_prods WHERE prod_aval = 'Cadeira Gamer Black Hawk Elg Preta e Vermelha'");
						$_getAval->execute();
						$_getAvalFetch = $_getAval->fetchAll(PDO::FETCH_ASSOC);

							$_getAvalAverage = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Cadeira Gamer Black Hawk Elg Preta e Vermelha'");

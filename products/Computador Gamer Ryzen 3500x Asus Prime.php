<?php session_start();?>
		...
		<html>
		 <head>
		 	<title>Computador Gamer Ryzen 3500x Asus Prime</title>
   ...
   <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
		  ...
		  <?php require_once('../php/nav.php');?>
			...
			<div id='container-item'>
				<div id='div-img-left'>
					<div id='div-extra-imgs'>
						<img src='../imgsextra/331d469d0772ae37275736911033fab8.png' class='extra-imgs' id='imgextra0' onclick='iimgextra1()'><br>
						<img src='../imgsextra/76e1229ad966d21cc59b68bc97abe66d.png' class='extra-imgs' id='imgextra1' onclick='iimgextra2()'><br>
						<img src='../imgsextra/60ab5bd93b15f53f7e145d868d2c10ad.jpg' class='extra-imgs' id='imgextra2' onclick='iimgextra3()'><br>
						<img src='../imgsextra/0131f51abb3ccdb98485581f21084034.jpg' class='extra-imgs' id='imgextra3' onclick='iimgextra4()'>
					</div>
					<img src='../upload/40715a040b9a6ab22b9a0bfa97d22e70.jpg' id='img-left'>
				</div>
				<div id='div-infos-product'>
					<b id='title'>Computador Gamer Ryzen 3500x Asus Prime</b><br>
					<div id='evaluation' style='position: relative; height: 1.3vw;'>
						...
						<?php
											...
											$_selectAll = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Computador Gamer Ryzen 3500x Asus Prime'");
											$_selectAll->execute();
	 				 ...
	 				 <b id='price'><h2 style='color: gray; text-decoration: line-through; font-size: 20px;'>R$ 3.250,00</h2><h2 id='price-real-confirm'> R$ 2.567,50</h2><b style='font-size: 18px;'>Ou 10x de R$ 256,75</b><br></b><br>
	 				  
					<form method='post' action='../inserts/insertCarrinho?np=<?php echo 'Computador Gamer Ryzen 3500x Asus Prime';?>'>
			...
			<div id='features-prod-b'><b>Características Gerais</b></div><br>
				...
				<?php
						...
						$_sql = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Computador Gamer Ryzen 3500x Asus Prime'");
						$_sql->execute();
	...
	<?php }?>
    	...
    	<?php 
						$_getAval = $_pdo->prepare("SELECT * FROM avalia_prods WHERE prod_aval = 'Computador Gamer Ryzen 3500x Asus Prime'");
						$_getAval->execute();
						$_getAvalFetch = $_getAval->fetchAll(PDO::FETCH_ASSOC);

							$_getAvalAverage = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Computador Gamer Ryzen 3500x Asus Prime'");

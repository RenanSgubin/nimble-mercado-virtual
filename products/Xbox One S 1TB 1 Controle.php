<?php session_start();?>
		...
		<html>
		 <head>
		 	<title>Xbox One S 1TB 1 Controle</title>
   ...
   <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
		  ...
		  <?php require_once('../php/nav.php');?>
			...
			<div id='container-item'>
				<div id='div-img-left'>
					<div id='div-extra-imgs'>
						<img src='../imgsextra/59c95b34ec68656469612130922ddea0.png' class='extra-imgs' id='imgextra0' onclick='iimgextra1()'><br>
						<img src='../imgsextra/00a3db936b03cb040a71ca5aa1ec186f.png' class='extra-imgs' id='imgextra1' onclick='iimgextra2()'><br>
						<img src='../imgsextra/9e251abff75987251d7cafb6e876df24.jpg' class='extra-imgs' id='imgextra2' onclick='iimgextra3()'><br>
						<img src='../imgsextra/55d61afd2f4de6393c5a00fb94013e05.jpg' class='extra-imgs' id='imgextra3' onclick='iimgextra4()'>
					</div>
					<img src='../upload/80574839aa24dbab771b399f79267f57.jpg' id='img-left'>
				</div>
				<div id='div-infos-product'>
					<b id='title'>Xbox One S 1TB 1 Controle</b><br>
					<div id='evaluation' style='position: relative; height: 1.3vw;'>
						...
						<?php
											...
											$_selectAll = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Xbox One S 1TB 1 Controle'");
											$_selectAll->execute();
	 				 ...
	 				 <b id='price'>R$ 3100<br><b style='font-size: 17px;'>Ou 10x de R$ 310,00</b><br></b><br>
	 				  
					<form method='post' action='../inserts/insertCarrinho?np=<?php echo 'Xbox One S 1TB 1 Controle';?>'>
			...
			<div id='features-prod-b'><b>Características Gerais</b></div><br>
				...
				<?php
						...
						$_sql = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Xbox One S 1TB 1 Controle'");
						$_sql->execute();
	...
	<?php }?>
    	...
    	<?php 
						$_getAval = $_pdo->prepare("SELECT * FROM avalia_prods WHERE prod_aval = 'Xbox One S 1TB 1 Controle'");
						$_getAval->execute();
						$_getAvalFetch = $_getAval->fetchAll(PDO::FETCH_ASSOC);

							$_getAvalAverage = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Xbox One S 1TB 1 Controle'");

<?php session_start();?>
		...
		<html>
		 <head>
		 	<title>Acer Aspire 5 A514-53G-571X Intel Core i5 8g</title>
   ...
   <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
		 ...
		 <body>
		  <?php require_once('../php/nav.php');?>
			...
			<div id='container-item'>
				<div id='div-img-left'>
					<div id='div-extra-imgs'>
						<img src='../imgsextra/c4d3dcb9c010af42b8b4754b6687389c.png' class='extra-imgs' id='imgextra0' onclick='iimgextra1()'><br>
						<img src='../imgsextra/3ecb7ddbffa07a928ad77164f2a79622.png' class='extra-imgs' id='imgextra1' onclick='iimgextra2()'><br>
						<img src='../imgsextra/aa6f64a9824c23e5647bd7c8a08075f2.jpg' class='extra-imgs' id='imgextra2' onclick='iimgextra3()'><br>
						<img src='../imgsextra/c8ecbd2cf096115aa1c8ffa618a456a9.jpg' class='extra-imgs' id='imgextra3' onclick='iimgextra4()'>
					</div>
					<img src='../upload/6c3abe9d752810a9c2e6919686a4beff.jpg' id='img-left'>
				</div>
				<div id='div-infos-product'>
					<b id='title'>Acer Aspire 5 A514-53G-571X Intel Core i5 8g</b><br>
					<div id='evaluation' style='position: relative; height: 1.3vw;'>
						...
						<?php
											...
											$_selectAll = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Acer Aspire 5 A514-53G-571X Intel Core i5 8g'");
											$_selectAll->execute();
	 				 ...
	 				 <b id='price'>R$ 1300<br><b style='font-size: 17px;'>Ou 5x de R$ 260,00</b><br></b><br>
	 				  
					<form method='post' action='../inserts/insertCarrinho?np=<?php echo 'Acer Aspire 5 A514-53G-571X Intel Core i5 8g';?>'>
			...
			<div id='desc-prod'>
				...
				<div id='alig-desc'>Xbox One S 1TB 1 Controle </div>
			</div><br><br>
			...
			<div id='features-prod-b'><b>Características Gerais</b></div><br>
				...
				<?php
						...
						$_sql = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Acer Aspire 5 A514-53G-571X Intel Core i5 8g'");
						$_sql->execute();
	...
	<?php }?>
    	...
    	<?php 
						$_getAval = $_pdo->prepare("SELECT * FROM avalia_prods WHERE prod_aval = 'Acer Aspire 5 A514-53G-571X Intel Core i5 8g'");
						$_getAval->execute();
						$_getAvalFetch = $_getAval->fetchAll(PDO::FETCH_ASSOC);

							$_getAvalAverage = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Acer Aspire 5 A514-53G-571X Intel Core i5 8g'");

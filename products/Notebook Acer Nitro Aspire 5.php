<?php session_start();?>
		...
		<html>
		 <head>
		 	<title>Notebook Acer Nitro Aspire 5</title>
		 ...
		 <body>
		  <?php require_once('../php/nav.php');?>
			...
			<div id='container-item'>
				<div id='div-img-left'>
					<div id='div-extra-imgs'>
						<img src='../imgsextra/dbefadd2806314f440cebc278a56bcdd.png' class='extra-imgs' id='imgextra0' onclick='iimgextra1()'><br>
						<img src='../imgsextra/e9576fc259be8b99b492b8b585a5db7a.png' class='extra-imgs' id='imgextra1' onclick='iimgextra2()'><br>
						<img src='../imgsextra/44410ea01a2072f444a5bd2fb9390eaf.png' class='extra-imgs' id='imgextra2' onclick='iimgextra3()'><br>
						<img src='../imgsextra/cd0fcd006cb385b8f6dcd8d0d47d46a9.png' class='extra-imgs' id='imgextra3' onclick='iimgextra4()'>
					</div>
					<img src='../upload/ef65ccbb5732e3fa4999c10caac6ab0f.png' id='img-left'>
				</div>
				<div id='div-infos-product'>
					<b id='title'>Notebook Acer Nitro Aspire 5</b><br>
					<div id='evaluation' style='position: relative; height: 1.3vw;'>
						...
						<?php
											...
											$_selectAll = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Notebook Acer Nitro Aspire 5'");
											$_selectAll->execute();
	 				 ...
	 				 <b id='price'><h2 style='color: gray; text-decoration: line-through; font-size: 20px;'>R$ 5.100,00</h2><h2 id='price-real-confirm'> R$ 4.539,00</h2><b style='font-size: 18px;'>Ou 15x de R$ 302,60</b><br></b><br>
	 				  
					<form method='post' action='../inserts/insertCarrinho?np=<?php echo 'Notebook Acer Nitro Aspire 5';?>'>
			...
			<div id='desc-prod'>
				...
				<div id='alig-desc'>
Notebook Acer Nitro Aspire 5 </div>
			</div><br><br>
			...
			<div id='features-prod-b'><b>Características Gerais</b></div><br>
				...
				<?php
						...
						$_sql = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Notebook Acer Nitro Aspire 5'");
						$_sql->execute();
	...
	<?php }?>
    	...
    	<?php 
						$_getAval = $_pdo->prepare("SELECT * FROM avalia_prods WHERE prod_aval = 'Notebook Acer Nitro Aspire 5'");
						$_getAval->execute();
						$_getAvalFetch = $_getAval->fetchAll(PDO::FETCH_ASSOC);

							$_getAvalAverage = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Notebook Acer Nitro Aspire 5'");

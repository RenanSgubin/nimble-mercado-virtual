<?php session_start();?>
		...
		<html>
		 <head>
		 	<title>Halo Infinite Xbox One</title>
   ...
   <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
		 ...
		 <body>
		  <?php require_once('../php/nav.php');?>
			...
			<div id='container-item'>
				<div id='div-img-left'>
					<div id='div-extra-imgs'>
						<img src='../imgsextra/5f61bf16c6adb295e73f4c012b2670a4.png' class='extra-imgs' id='imgextra0' onclick='iimgextra1()'><br>
						<img src='../imgsextra/51df3208e83a0b29ae9e1978d771e1df.png' class='extra-imgs' id='imgextra1' onclick='iimgextra2()'><br>
						<img src='../imgsextra/9b980e9d2aca47c35787b3c178650387.jpg' class='extra-imgs' id='imgextra2' onclick='iimgextra3()'><br>
						<img src='../imgsextra/70b09bebcfe8b3f68772b13546faf2a9.jpg' class='extra-imgs' id='imgextra3' onclick='iimgextra4()'>
					</div>
					<img src='../upload/59158c6c6b8602ea82dc488a7226960d.jpg' id='img-left'>
				</div>
				<div id='div-infos-product'>
					<b id='title'>Halo Infinite Xbox One</b><br>
					<div id='evaluation' style='position: relative; height: 1.3vw;'>
						...
						<?php
											...
											$_selectAll = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Halo Infinite Xbox One'");
											$_selectAll->execute();
	 				 ...
	 				 <b id='price'><h2 style='color: gray; text-decoration: line-through; font-size: 20px;'>R$ 140,00</h2><h2 id='price-real-confirm'> R$ 120,40</h2><b style='font-size: 18px;'>Ou 5x de R$ 24,08</b><br></b><br>
	 				  
					<form method='post' action='../inserts/insertCarrinho?np=<?php echo 'Halo Infinite Xbox One';?>'>
			...
			<div id='desc-prod'>
				...
				<div id='alig-desc'>Halo Infinite Xbox One </div>
			</div><br><br>
			...
			<div id='features-prod-b'><b>Características Gerais</b></div><br>
				...
				<?php
						...
						$_sql = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Halo Infinite Xbox One'");
						$_sql->execute();
	...
	<?php }?>
    	...
    	<?php 
						$_getAval = $_pdo->prepare("SELECT * FROM avalia_prods WHERE prod_aval = 'Halo Infinite Xbox One'");
						$_getAval->execute();
						$_getAvalFetch = $_getAval->fetchAll(PDO::FETCH_ASSOC);

							$_getAvalAverage = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Halo Infinite Xbox One'");

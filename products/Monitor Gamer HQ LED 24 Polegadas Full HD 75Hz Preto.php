<?php session_start();?>
		...
		<html>
		 <head>
		 	<title>Monitor Gamer HQ LED 24 Polegadas Full HD 75Hz Preto</title>
   ...
   <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
		 ...
		 <body>
		  <?php require_once('../php/nav.php');?>
			...
			<div id='container-item'>
				<div id='div-img-left'>
					<div id='div-extra-imgs'>
						<img src='../imgsextra/023154ab25d6763d2c899adbcd02592d.png' class='extra-imgs' id='imgextra0' onclick='iimgextra1()'><br>
						<img src='../imgsextra/53f33d04693ba9798a7820852c6e58d7.png' class='extra-imgs' id='imgextra1' onclick='iimgextra2()'><br>
						<img src='../imgsextra/c351751b795b1257b5ad37aa52360b52.jpg' class='extra-imgs' id='imgextra2' onclick='iimgextra3()'><br>
						<img src='../imgsextra/4c044233d118f07c401ec22b4bd86bd4.jpg' class='extra-imgs' id='imgextra3' onclick='iimgextra4()'>
					</div>
					<img src='../upload/42ea63a2f6070ea3e29b37b33d3b2ec9.jpg' id='img-left'>
				</div>
				<div id='div-infos-product'>
					<b id='title'>Monitor Gamer HQ LED 24 Polegadas Full HD 75Hz Preto</b><br>
					<div id='evaluation' style='position: relative; height: 1.3vw;'>
						...
						<?php
											...
											$_selectAll = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Monitor Gamer HQ LED 24 Polegadas Full HD 75Hz Preto'");
											$_selectAll->execute();
	 				 ...
	 				 <b id='price'><h2 style='color: gray; text-decoration: line-through; font-size: 20px;'>R$ 1.400,00</h2><h2 id='price-real-confirm'> R$ 1.330,00</h2><b style='font-size: 18px;'>Ou 5x de R$ 266,00</b><br></b><br>
	 				  
					<form method='post' action='../inserts/insertCarrinho?np=<?php echo 'Monitor Gamer HQ LED 24 Polegadas Full HD 75Hz Preto';?>'>
			...
			<div id='desc-prod'>
				...
				<div id='alig-desc'>Monitor Gamer HQ LED 24 Polegadas Full HD 75Hz Preto </div>
			</div><br><br>
			...
			<div id='features-prod-b'><b>Características Gerais</b></div><br>
				...
				<?php
						...
						$_sql = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Monitor Gamer HQ LED 24 Polegadas Full HD 75Hz Preto'");
						$_sql->execute();
	...
	<?php }?>
    	...
    	<?php 
						$_getAval = $_pdo->prepare("SELECT * FROM avalia_prods WHERE prod_aval = 'Monitor Gamer HQ LED 24 Polegadas Full HD 75Hz Preto'");
						$_getAval->execute();
						$_getAvalFetch = $_getAval->fetchAll(PDO::FETCH_ASSOC);

							$_getAvalAverage = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Monitor Gamer HQ LED 24 Polegadas Full HD 75Hz Preto'");

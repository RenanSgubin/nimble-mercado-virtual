<?php session_start();?>
		...
		<html>
		 <head>
		 	<title>Cyberpunk 2077 - PS4 </title>
   ...
   <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
		 ...
		 <body>
		  <?php require_once('../php/nav.php');?>
			...
			<div id='container-item'>
				<div id='div-img-left'>
					<div id='div-extra-imgs'>
						<img src='../imgsextra/a50cfa64d765faae881efc7213bd2919.png' class='extra-imgs' id='imgextra0' onclick='iimgextra1()'><br>
						<img src='../imgsextra/48ff0321255e4a98e6fd98804cd40933.jpg' class='extra-imgs' id='imgextra1' onclick='iimgextra2()'><br>
						<img src='../imgsextra/2f79224c4c4d2bd44199c26f735d46b4.jpg' class='extra-imgs' id='imgextra2' onclick='iimgextra3()'><br>
						<img src='../imgsextra/4dd68ce52ae5f7d40b0492813be06fb8.jpg' class='extra-imgs' id='imgextra3' onclick='iimgextra4()'>
					</div>
					<img src='../upload/4869ca5ada6b30d0c85b606a870a063c.jpg' id='img-left'>
				</div>
				<div id='div-infos-product'>
					<b id='title'>Cyberpunk 2077 - PS4 </b><br>
					<div id='evaluation' style='position: relative; height: 1.3vw;'>
						...
						<?php
											...
											$_selectAll = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Cyberpunk 2077 - PS4 '");
											$_selectAll->execute();
	 				 ...
	 				 <b id='price'>R$ 220<br><b style='font-size: 17px;'>Ou 5x de R$ 44,00</b><br></b><br>
	 				  
					<form method='post' action='../inserts/insertCarrinho?np=<?php echo 'Cyberpunk 2077 - PS4 ';?>'>
			...
			<div id='desc-prod'>
				...
				<div id='alig-desc'>Cyberpunk 2077 - PS4  </div>
			</div><br><br>
			...
			<div id='features-prod-b'><b>Características Gerais</b></div><br>
				...
				<?php
						...
						$_sql = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Cyberpunk 2077 - PS4 '");
						$_sql->execute();
	...
	<?php }?>
    	...
    	<?php 
						$_getAval = $_pdo->prepare("SELECT * FROM avalia_prods WHERE prod_aval = 'Cyberpunk 2077 - PS4 '");
						$_getAval->execute();
						$_getAvalFetch = $_getAval->fetchAll(PDO::FETCH_ASSOC);

							$_getAvalAverage = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Cyberpunk 2077 - PS4 '");

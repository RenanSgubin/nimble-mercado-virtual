<?php session_start();?>
		...
		<html>
		 <head>
		 	<title>Cadeira Gamer DX Racer New Max (PC188 - NR)</title>
   ...
   <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
		 ...
		 <body>
		  <?php require_once('../php/nav.php');?>
			...
			<div id='container-item'>
				<div id='div-img-left'>
					<div id='div-extra-imgs'>
						<img src='../imgsextra/f85850451408164bea3ae800310ae127.png' class='extra-imgs' id='imgextra0' onclick='iimgextra1()'><br>
						<img src='../imgsextra/cc5b52fbf20ed24c27e2af34369948bf.png' class='extra-imgs' id='imgextra1' onclick='iimgextra2()'><br>
						<img src='../imgsextra/adf3f352d8e23be72f2f4ae777e25440.jpg' class='extra-imgs' id='imgextra2' onclick='iimgextra3()'><br>
						<img src='../imgsextra/c0d43293a8ae63e1030275f1fd9a2299.jpg' class='extra-imgs' id='imgextra3' onclick='iimgextra4()'>
					</div>
					<img src='../upload/de9d0f1ebf2aca356df813a9c448e7e7.jpg' id='img-left'>
				</div>
				<div id='div-infos-product'>
					<b id='title'>Cadeira Gamer DX Racer New Max (PC188 - NR)</b><br>
					<div id='evaluation' style='position: relative; height: 1.3vw;'>
						...
						<?php
											...
											$_selectAll = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Cadeira Gamer DX Racer New Max (PC188 - NR)'");
											$_selectAll->execute();
	 				 ...
	 				 <b id='price'><h2 style='color: gray; text-decoration: line-through; font-size: 20px;'>R$ 2.700,00</h2><h2 id='price-real-confirm'> R$ 2.268,00</h2><b style='font-size: 18px;'>Ou 5x de R$ 453,60</b><br></b><br>
	 				  
					<form method='post' action='../inserts/insertCarrinho?np=<?php echo 'Cadeira Gamer DX Racer New Max (PC188 - NR)';?>'>
			...
			<div id='desc-prod'>
				...
				<div id='alig-desc'>Fall Guys PS4 </div>
			</div><br><br>
			...
			<div id='features-prod-b'><b>Características Gerais</b></div><br>
				...
				<?php
						...
						$_sql = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Cadeira Gamer DX Racer New Max (PC188 - NR)'");
						$_sql->execute();
	...
	<?php }?>
    	...
    	<?php 
						$_getAval = $_pdo->prepare("SELECT * FROM avalia_prods WHERE prod_aval = 'Cadeira Gamer DX Racer New Max (PC188 - NR)'");
						$_getAval->execute();
						$_getAvalFetch = $_getAval->fetchAll(PDO::FETCH_ASSOC);

							$_getAvalAverage = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Cadeira Gamer DX Racer New Max (PC188 - NR)'");

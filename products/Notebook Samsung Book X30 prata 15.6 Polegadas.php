<?php session_start();?>
		...
		<html>
		 <head>
		 	<title>Notebook Samsung Book X30 prata 15.6 Polegadas</title>
		 ...
		 <body>
		  <?php require_once('../php/nav.php');?>
			...
			<div id='container-item'>
				<div id='div-img-left'>
					<div id='div-extra-imgs'>
						<img src='../imgsextra/a8b35c7b7227b16c5faf97418130c58f.png' class='extra-imgs' id='imgextra0' onclick='iimgextra1()'><br>
						<img src='../imgsextra/87ff0b8fbd2354183c3ee0b2d6ccf933.png' class='extra-imgs' id='imgextra1' onclick='iimgextra2()'><br>
						<img src='../imgsextra/37154f21cca6ef35d78b1edb287a9351.png' class='extra-imgs' id='imgextra2' onclick='iimgextra3()'><br>
						<img src='../imgsextra/2caf90b053bf87b451da6a5811e20adf.png' class='extra-imgs' id='imgextra3' onclick='iimgextra4()'>
					</div>
					<img src='../upload/505a900b3def178edbbc97b2b9000db1.png' id='img-left'>
				</div>
				<div id='div-infos-product'>
					<b id='title'>Notebook Samsung Book X30 prata 15.6 Polegadas</b><br>
					<div id='evaluation' style='position: relative; height: 1.3vw;'>
						...
						<?php
											...
											$_selectAll = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Notebook Samsung Book X30 prata 15.6 Polegadas'");
											$_selectAll->execute();
	 				 ...
	 				 <b id='price'><h2 style='color: gray; text-decoration: line-through; font-size: 20px;'>R$ 3.800,00</h2><h2 id='price-real-confirm'> R$ 3.534,00</h2><b style='font-size: 18px;'>Ou 10x de R$ 353,40</b><br></b><br>
	 				  
					<form method='post' action='../inserts/insertCarrinho?np=<?php echo 'Notebook Samsung Book X30 prata 15.6 Polegadas';?>'>
			...
			<div id='desc-prod'>
				...
				<div id='alig-desc'>Notebook Samsung Book X30 prata 15.6", Intel Core i5 10210U 8GB de RAM 1TB HDD, Intel UHD Graphics 1366x768px Windows 10 Home.<br>
...
Notebook prateado e minimalista para agradar todo e qualquer usuário.
			...
			<div id='features-prod-b'><b>Características Gerais</b></div><br>
				...
				<?php
						...
						$_sql = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Notebook Samsung Book X30 prata 15.6 Polegadas'");
						$_sql->execute();
	...
	<?php }?>
    	...
    	<?php 
						$_getAval = $_pdo->prepare("SELECT * FROM avalia_prods WHERE prod_aval = 'Notebook Samsung Book X30 prata 15.6 Polegadas'");
						$_getAval->execute();
						$_getAvalFetch = $_getAval->fetchAll(PDO::FETCH_ASSOC);

							$_getAvalAverage = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Notebook Samsung Book X30 prata 15.6 Polegadas'");

<?php session_start();?>
		...
		<html>
		 <head>
		 	<title>Computador Gamer Completo Com Monitor Led Intel</title>
   ...
   <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
		 ...
		 <body>
		  <?php require_once('../php/nav.php');?>
			...
			<div id='container-item'>
				<div id='div-img-left'>
					<div id='div-extra-imgs'>
						<img src='../imgsextra/0d16d21277ef78db35d840872d685b05.jpg' class='extra-imgs' id='imgextra0' onclick='iimgextra1()'><br>
						<img src='../imgsextra/c23706f6f7a0431e2db92e95019bf32a.png' class='extra-imgs' id='imgextra1' onclick='iimgextra2()'><br>
						<img src='../imgsextra/0751b3d46858cb507a0c14312baac61d.jpg' class='extra-imgs' id='imgextra2' onclick='iimgextra3()'><br>
						<img src='../imgsextra/aae87c21c3e0d9ebf639409dc5a1d0ed.jpg' class='extra-imgs' id='imgextra3' onclick='iimgextra4()'>
					</div>
					<img src='../upload/9bdf2a00ef35a4a1bae8aa3a3017c9b4.jpg' id='img-left'>
				</div>
				<div id='div-infos-product'>
					<b id='title'>Computador Gamer Completo Com Monitor Led Intel</b><br>
					<div id='evaluation' style='position: relative; height: 1.3vw;'>
						...
						<?php
											...
											$_selectAll = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Computador Gamer Completo Com Monitor Led Intel'");
											$_selectAll->execute();
	 				 ...
	 				 <b id='price'>R$ 2999<br><b style='font-size: 17px;'>Ou 10x de R$ 299,90</b><br></b><br>
	 				  
					<form method='post' action='../inserts/insertCarrinho?np=<?php echo 'Computador Gamer Completo Com Monitor Led Intel';?>'>
			...
			<div id='desc-prod'>
				...
				<div id='alig-desc'>Computador Gamer Completo Com Monitor Led Intel </div>
			</div><br><br>
			...
			<div id='features-prod-b'><b>Características Gerais</b></div><br>
				...
				<?php
						...
						$_sql = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Computador Gamer Completo Com Monitor Led Intel'");
						$_sql->execute();
	...
	<?php }?>
    	...
    	<?php 
						$_getAval = $_pdo->prepare("SELECT * FROM avalia_prods WHERE prod_aval = 'Computador Gamer Completo Com Monitor Led Intel'");
						$_getAval->execute();
						$_getAvalFetch = $_getAval->fetchAll(PDO::FETCH_ASSOC);

							$_getAvalAverage = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Computador Gamer Completo Com Monitor Led Intel'");

<?php session_start();?>
		...
		<html>
		 <head>
		 	<title>Notebook Acer Aspire 3 AMD Ryzen 5</title>
   ...
   <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
		 ...
		 <body>
		  <?php require_once('../php/nav.php');?>
			...
			<div id='container-item'>
				<div id='div-img-left'>
					<div id='div-extra-imgs'>
						<img src='../imgsextra/e291f847176103dc8bb62ec09e97f016.png' class='extra-imgs' id='imgextra0' onclick='iimgextra1()'><br>
						<img src='../imgsextra/17f6fef914894c11b9b14363e98d808c.png' class='extra-imgs' id='imgextra1' onclick='iimgextra2()'><br>
						<img src='../imgsextra/62ac008e47cd0a793ea14940381d5af3.png' class='extra-imgs' id='imgextra2' onclick='iimgextra3()'><br>
						<img src='../imgsextra/90a6d980d5647d7a312fcdfecd92c791.png' class='extra-imgs' id='imgextra3' onclick='iimgextra4()'>
					</div>
					<img src='../upload/c629e914fc644f8132be476cb2c002cf.jpg' id='img-left'>
				</div>
				<div id='div-infos-product'>
					<b id='title'>Notebook Acer Aspire 3 AMD Ryzen 5</b><br>
					<div id='evaluation' style='position: relative; height: 1.3vw;'>
						...
						<?php
											...
											$_selectAll = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Notebook Acer Aspire 3 AMD Ryzen 5'");
											$_selectAll->execute();
	 				 ...
	 				 <b id='price'><h2 style='color: gray; text-decoration: line-through; font-size: 20px;'>R$ 4.200,00</h2><h2 id='price-real-confirm'> R$ 3.654,00</h2><b style='font-size: 18px;'>Ou 10x de R$ 365,40</b><br></b><br>
	 				  
					<form method='post' action='../inserts/insertCarrinho?np=<?php echo 'Notebook Acer Aspire 3 AMD Ryzen 5';?>'>
			...
			<div id='desc-prod'>
				...
				<div id='alig-desc'>Notebook Acer Aspire 3 AMD Ryzen 5 </div>
			</div><br><br>
			...
			<div id='features-prod-b'><b>Características Gerais</b></div><br>
				...
				<?php
						...
						$_sql = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Notebook Acer Aspire 3 AMD Ryzen 5'");
						$_sql->execute();
	...
	<?php }?>
    	...
    	<?php 
						$_getAval = $_pdo->prepare("SELECT * FROM avalia_prods WHERE prod_aval = 'Notebook Acer Aspire 3 AMD Ryzen 5'");
						$_getAval->execute();
						$_getAvalFetch = $_getAval->fetchAll(PDO::FETCH_ASSOC);

							$_getAvalAverage = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Notebook Acer Aspire 3 AMD Ryzen 5'");

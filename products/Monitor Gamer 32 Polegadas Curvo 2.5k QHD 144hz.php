<?php session_start();?>
		...
		<html>
		 <head>
		 	<title>Monitor Gamer 32 Polegadas Curvo 2.5k QHD 144hz</title>
   ...
   <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
		 ...
		 <body>
		  <?php require_once('../php/nav.php');?>
			...
			<div id='container-item'>
				<div id='div-img-left'>
					<div id='div-extra-imgs'>
						<img src='../imgsextra/e2e8acd729b74b15c761e57fc825bb7a.jpg' class='extra-imgs' id='imgextra0' onclick='iimgextra1()'><br>
						<img src='../imgsextra/f4da56bbc2a772ab2067710f876b25e5.png' class='extra-imgs' id='imgextra1' onclick='iimgextra2()'><br>
						<img src='../imgsextra/9a80f735a4948b29779cf410d7341c8e.jpg' class='extra-imgs' id='imgextra2' onclick='iimgextra3()'><br>
						<img src='../imgsextra/159b4324ffc589995e6fb4b3a0c09898.jpg' class='extra-imgs' id='imgextra3' onclick='iimgextra4()'>
					</div>
					<img src='../upload/c0b6869101f2da9d15433efaac59f4c0.jpg' id='img-left'>
				</div>
				<div id='div-infos-product'>
					<b id='title'>Monitor Gamer 32 Polegadas Curvo 2.5k QHD 144hz</b><br>
					<div id='evaluation' style='position: relative; height: 1.3vw;'>
						...
						<?php
											...
											$_selectAll = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Monitor Gamer 32 Polegadas Curvo 2.5k QHD 144hz'");
											$_selectAll->execute();
	 				 ...
	 				 <b id='price'>R$ 2867<br><b style='font-size: 17px;'>Ou 10x de R$ 286,70</b><br></b><br>
	 				  
					<form method='post' action='../inserts/insertCarrinho?np=<?php echo 'Monitor Gamer 32 Polegadas Curvo 2.5k QHD 144hz';?>'>
			...
			<div id='desc-prod'>
				...
				<div id='alig-desc'>Monitor Gamer 32 Polegadas Curvo 2.5k QHD 144hz </div>
			</div><br><br>
			...
			<div id='features-prod-b'><b>Características Gerais</b></div><br>
				...
				<?php
						...
						$_sql = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Monitor Gamer 32 Polegadas Curvo 2.5k QHD 144hz'");
						$_sql->execute();
	...
	<?php }?>
    	...
    	<?php 
						$_getAval = $_pdo->prepare("SELECT * FROM avalia_prods WHERE prod_aval = 'Monitor Gamer 32 Polegadas Curvo 2.5k QHD 144hz'");
						$_getAval->execute();
						$_getAvalFetch = $_getAval->fetchAll(PDO::FETCH_ASSOC);

							$_getAvalAverage = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Monitor Gamer 32 Polegadas Curvo 2.5k QHD 144hz'");

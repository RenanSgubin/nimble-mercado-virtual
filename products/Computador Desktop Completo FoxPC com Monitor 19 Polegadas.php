<?php session_start();?>
		...
		<html>
		 <head>
		 	<title>Computador Desktop Completo FoxPC com Monitor 19 Polegadas</title>
   ...
   <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
		 ...
		 <body>
		  <?php require_once('../php/nav.php');?>
			...
			<div id='container-item'>
				<div id='div-img-left'>
					<div id='div-extra-imgs'>
						<img src='../imgsextra/30e206d72e213f594e09d25b2b47c9fc.jpg' class='extra-imgs' id='imgextra0' onclick='iimgextra1()'><br>
						<img src='../imgsextra/8c00ef09b5dc3330037da13d42120431.png' class='extra-imgs' id='imgextra1' onclick='iimgextra2()'><br>
						<img src='../imgsextra/ba0c0b4042e423936704b1c1a8769534.jpg' class='extra-imgs' id='imgextra2' onclick='iimgextra3()'><br>
						<img src='../imgsextra/e8b0176dbfb91faee6e28fb077c47446.jpg' class='extra-imgs' id='imgextra3' onclick='iimgextra4()'>
					</div>
					<img src='../upload/204efe807d74dae61ede317d8f1e86f8.jpg' id='img-left'>
				</div>
				<div id='div-infos-product'>
					<b id='title'>Computador Desktop Completo FoxPC com Monitor 19 Polegadas</b><br>
					<div id='evaluation' style='position: relative; height: 1.3vw;'>
						...
						<?php
											...
											$_selectAll = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Computador Desktop Completo FoxPC com Monitor 19 Polegadas'");
											$_selectAll->execute();
	 				 ...
	 				 <b id='price'>R$ 2181<br><b style='font-size: 17px;'>Ou 5x de R$ 436,20</b><br></b><br>
	 				  
					<form method='post' action='../inserts/insertCarrinho?np=<?php echo 'Computador Desktop Completo FoxPC com Monitor 19 Polegadas';?>'>
			...
			<div id='desc-prod'>
				...
				<div id='alig-desc'>Computador Desktop Completo FoxPC com Monitor 19 Polegadas </div>
			</div><br><br>
			...
			<div id='features-prod-b'><b>Características Gerais</b></div><br>
				...
				<?php
						...
						$_sql = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Computador Desktop Completo FoxPC com Monitor 19 Polegadas'");
						$_sql->execute();
	...
	<?php }?>
    	...
    	<?php 
						$_getAval = $_pdo->prepare("SELECT * FROM avalia_prods WHERE prod_aval = 'Computador Desktop Completo FoxPC com Monitor 19 Polegadas'");
						$_getAval->execute();
						$_getAvalFetch = $_getAval->fetchAll(PDO::FETCH_ASSOC);

							$_getAvalAverage = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Computador Desktop Completo FoxPC com Monitor 19 Polegadas'");

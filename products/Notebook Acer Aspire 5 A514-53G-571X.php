<?php session_start();?>
		...
		<html>
		 <head>
		 	<title>Notebook Acer Aspire 5 A514-53G-571X</title>
   ...
   <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
		 ...
		 <body>
		  <?php require_once('../php/nav.php');?>
			...
			<div id='container-item'>
				<div id='div-img-left'>
					<div id='div-extra-imgs'>
						<img src='../imgsextra/c6e34023eaab7a2c5b7c3cffe4223ad6.jpg' class='extra-imgs' id='imgextra0' onclick='iimgextra1()'><br>
						<img src='../imgsextra/d4c66ae3619a0e212da42f92d8e209d3.png' class='extra-imgs' id='imgextra1' onclick='iimgextra2()'><br>
						<img src='../imgsextra/0c08aa0ae8b8a240799e65a26942b5c2.jpg' class='extra-imgs' id='imgextra2' onclick='iimgextra3()'><br>
						<img src='../imgsextra/0c96d9fd2dc27b45dfaac1f3caa594f7.jpg' class='extra-imgs' id='imgextra3' onclick='iimgextra4()'>
					</div>
					<img src='../upload/368d073a79b2e772c93cdbdc9942620f.jpg' id='img-left'>
				</div>
				<div id='div-infos-product'>
					<b id='title'>Notebook Acer Aspire 5 A514-53G-571X</b><br>
					<div id='evaluation' style='position: relative; height: 1.3vw;'>
						...
						<?php
											...
											$_selectAll = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Notebook Acer Aspire 5 A514-53G-571X'");
											$_selectAll->execute();
	 				 ...
	 				 <b id='price'>R$ 4899<br><b style='font-size: 17px;'>Ou 15x de R$ 326,60</b><br></b><br>
	 				  
					<form method='post' action='../inserts/insertCarrinho?np=<?php echo 'Notebook Acer Aspire 5 A514-53G-571X';?>'>
			...
			<div id='desc-prod'>
				...
				<div id='alig-desc'>Notebook Acer Aspire 5 A514-53G-571X </div>
			</div><br><br>
			...
			<div id='features-prod-b'><b>Características Gerais</b></div><br>
				...
				<?php
						...
						$_sql = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Notebook Acer Aspire 5 A514-53G-571X'");
						$_sql->execute();
	...
	<?php }?>
    	...
    	<?php 
						$_getAval = $_pdo->prepare("SELECT * FROM avalia_prods WHERE prod_aval = 'Notebook Acer Aspire 5 A514-53G-571X'");
						$_getAval->execute();
						$_getAvalFetch = $_getAval->fetchAll(PDO::FETCH_ASSOC);

							$_getAvalAverage = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Notebook Acer Aspire 5 A514-53G-571X'");

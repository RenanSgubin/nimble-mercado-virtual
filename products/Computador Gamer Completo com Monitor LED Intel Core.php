<?php session_start();?>
		...
		<html>
		 <head>
		 	<title>Computador Gamer Completo com Monitor LED Intel Core</title>
   ...
   <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
		 ...
		 <body>
		  <?php require_once('../php/nav.php');?>
			...
			<div id='container-item'>
				<div id='div-img-left'>
					<div id='div-extra-imgs'>
						<img src='../imgsextra/66a2d7a5cfee8cce970b9047ca0bf69c.jpg' class='extra-imgs' id='imgextra0' onclick='iimgextra1()'><br>
						<img src='../imgsextra/37064accc56329e1c5a6474cb98273fa.png' class='extra-imgs' id='imgextra1' onclick='iimgextra2()'><br>
						<img src='../imgsextra/5155644f3bfd5e075a24939dffb65630.jpg' class='extra-imgs' id='imgextra2' onclick='iimgextra3()'><br>
						<img src='../imgsextra/ac9fbdf50836de9fc885f78b535fdd0d.jpg' class='extra-imgs' id='imgextra3' onclick='iimgextra4()'>
					</div>
					<img src='../upload/880ce4b1290b70e589c8fe40a3176c56.jpg' id='img-left'>
				</div>
				<div id='div-infos-product'>
					<b id='title'>Computador Gamer Completo com Monitor LED Intel Core</b><br>
					<div id='evaluation' style='position: relative; height: 1.3vw;'>
						...
						<?php
											...
											$_selectAll = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Computador Gamer Completo com Monitor LED Intel Core'");
											$_selectAll->execute();
	 				 ...
	 				 <b id='price'>R$ 2780<br><b style='font-size: 17px;'>Ou 10x de R$ 278,00</b><br></b><br>
	 				  
					<form method='post' action='../inserts/insertCarrinho?np=<?php echo 'Computador Gamer Completo com Monitor LED Intel Core';?>'>
			...
			<div id='desc-prod'>
				...
				<div id='alig-desc'>Computador Gamer Completo com Monitor LED Intel Core </div>
			</div><br><br>
			...
			<div id='features-prod-b'><b>Características Gerais</b></div><br>
				...
				<?php
						...
						$_sql = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Computador Gamer Completo com Monitor LED Intel Core'");
						$_sql->execute();
	...
	<?php }?>
    	...
    	<?php 
						$_getAval = $_pdo->prepare("SELECT * FROM avalia_prods WHERE prod_aval = 'Computador Gamer Completo com Monitor LED Intel Core'");
						$_getAval->execute();
						$_getAvalFetch = $_getAval->fetchAll(PDO::FETCH_ASSOC);

							$_getAvalAverage = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Computador Gamer Completo com Monitor LED Intel Core'");

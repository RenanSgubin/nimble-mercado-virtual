<?php session_start();?>
		...
		<html>
		 <head>
		 	<title>Monitor Gamer Curvo 24MN101 1 UN Warrior</title>
   ...
   <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
		 ...
		 <body>
		  <?php require_once('../php/nav.php');?>
			...
			<div id='container-item'>
				<div id='div-img-left'>
					<div id='div-extra-imgs'>
						<img src='../imgsextra/7b0babf90686190fe919e64c02be9084.jpg' class='extra-imgs' id='imgextra0' onclick='iimgextra1()'><br>
						<img src='../imgsextra/7d57ad48c69107c31af584d8b31c096b.png' class='extra-imgs' id='imgextra1' onclick='iimgextra2()'><br>
						<img src='../imgsextra/8f2f7ac4893591b64ea72049cb65f874.jpg' class='extra-imgs' id='imgextra2' onclick='iimgextra3()'><br>
						<img src='../imgsextra/089d782e14b1db6d36e4706fbaba2cf5.jpg' class='extra-imgs' id='imgextra3' onclick='iimgextra4()'>
					</div>
					<img src='../upload/6325f58dbe283623f7d58d22b6f5d940.jpg' id='img-left'>
				</div>
				<div id='div-infos-product'>
					<b id='title'>Monitor Gamer Curvo 24MN101 1 UN Warrior</b><br>
					<div id='evaluation' style='position: relative; height: 1.3vw;'>
						...
						<?php
											...
											$_selectAll = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Monitor Gamer Curvo 24MN101 1 UN Warrior'");
											$_selectAll->execute();
	 				 ...
	 				 <b id='price'>R$ 1990<br><b style='font-size: 17px;'>Ou 5x de R$ 398,00</b><br></b><br>
	 				  
					<form method='post' action='../inserts/insertCarrinho?np=<?php echo 'Monitor Gamer Curvo 24MN101 1 UN Warrior';?>'>
			...
			<div id='desc-prod'>
				...
				<div id='alig-desc'>Monitor Gamer Curvo 24MN101 1 UN Warrior </div>
			</div><br><br>
			...
			<div id='features-prod-b'><b>Características Gerais</b></div><br>
				...
				<?php
						...
						$_sql = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Monitor Gamer Curvo 24MN101 1 UN Warrior'");
						$_sql->execute();
	...
	<?php }?>
    	...
    	<?php 
						$_getAval = $_pdo->prepare("SELECT * FROM avalia_prods WHERE prod_aval = 'Monitor Gamer Curvo 24MN101 1 UN Warrior'");
						$_getAval->execute();
						$_getAvalFetch = $_getAval->fetchAll(PDO::FETCH_ASSOC);

							$_getAvalAverage = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Monitor Gamer Curvo 24MN101 1 UN Warrior'");

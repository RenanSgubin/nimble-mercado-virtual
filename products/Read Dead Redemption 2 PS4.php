<?php session_start();?>
		...
		<html>
		 <head>
		 	<title>Read Dead Redemption 2 PS4</title>
   ...
   <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
		  ...
		  <?php require_once('../php/nav.php');?>
			...
			<div id='container-item'>
				<div id='div-img-left'>
					<div id='div-extra-imgs'>
						<img src='../imgsextra/34521f187ecb8f7b362fc33f0419f895.png' class='extra-imgs' id='imgextra0' onclick='iimgextra1()'><br>
						<img src='../imgsextra/2f8fa793d2b9e07cba88c83087e6b0e3.png' class='extra-imgs' id='imgextra1' onclick='iimgextra2()'><br>
						<img src='../imgsextra/8f2020239eb7eb4a3ba4c4a7c92eeaf1.jpg' class='extra-imgs' id='imgextra2' onclick='iimgextra3()'><br>
						<img src='../imgsextra/904d377157f209338ef67ff69d140d11.jpg' class='extra-imgs' id='imgextra3' onclick='iimgextra4()'>
					</div>
					<img src='../upload/a7645770605cc0ced9a2641267bb10db.png' id='img-left'>
				</div>
				<div id='div-infos-product'>
					<b id='title'>Read Dead Redemption 2 PS4</b><br>
					<div id='evaluation' style='position: relative; height: 1.3vw;'>
						...
						<?php
											...
											$_selectAll = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Read Dead Redemption 2 PS4'");
											$_selectAll->execute();
	 				 ...
	 				 <b id='price'>R$ 160<br><b style='font-size: 17px;'>Ou 5x de R$ 32,00</b><br></b><br>
	 				  
					<form method='post' action='../inserts/insertCarrinho?np=<?php echo 'Read Dead Redemption 2 PS4';?>'>
			...
			<div id='features-prod-b'><b>Características Gerais</b></div><br>
				...
				<?php
						...
						$_sql = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Read Dead Redemption 2 PS4'");
						$_sql->execute();
	...
	<?php }?>
    	...
    	<?php 
						$_getAval = $_pdo->prepare("SELECT * FROM avalia_prods WHERE prod_aval = 'Read Dead Redemption 2 PS4'");
						$_getAval->execute();
						$_getAvalFetch = $_getAval->fetchAll(PDO::FETCH_ASSOC);

							$_getAvalAverage = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Read Dead Redemption 2 PS4'");

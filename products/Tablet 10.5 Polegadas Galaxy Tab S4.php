<?php session_start();?>
		...
		<html>
		 <head>
		 	<title>Tablet 10.5 Polegadas Galaxy Tab S4</title>
   ...
   <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
		  ...
		  <?php require_once('../php/nav.php');?>
			...
			<div id='container-item'>
				<div id='div-img-left'>
					<div id='div-extra-imgs'>
						<img src='../imgsextra/4fd7461649351eb0fda52fdd9eff8bfc.png' class='extra-imgs' id='imgextra0' onclick='iimgextra1()'><br>
						<img src='../imgsextra/71749d753e2f371215db955546cfcae1.png' class='extra-imgs' id='imgextra1' onclick='iimgextra2()'><br>
						<img src='../imgsextra/1e975e04a5c76d45b8dcfcfb5a671666.jpg' class='extra-imgs' id='imgextra2' onclick='iimgextra3()'><br>
						<img src='../imgsextra/7b822a21eba5bc42a93f9ad05dc2a8e1.jpg' class='extra-imgs' id='imgextra3' onclick='iimgextra4()'>
					</div>
					<img src='../upload/a32af9895aa68c8adfc5bdaa62a61b9b.jpg' id='img-left'>
				</div>
				<div id='div-infos-product'>
					<b id='title'>Tablet 10.5 Polegadas Galaxy Tab S4</b><br>
					<div id='evaluation' style='position: relative; height: 1.3vw;'>
						...
						<?php
											...
											$_selectAll = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Tablet 10.5 Polegadas Galaxy Tab S4'");
											$_selectAll->execute();
	 				 ...
	 				 <b id='price'>R$ 1400<br><b style='font-size: 17px;'>Ou 5x de R$ 280,00</b><br></b><br>
	 				  
					<form method='post' action='../inserts/insertCarrinho?np=<?php echo 'Tablet 10.5 Polegadas Galaxy Tab S4';?>'>
			...
			<div id='features-prod-b'><b>Características Gerais</b></div><br>
				...
				<?php
						...
						$_sql = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Tablet 10.5 Polegadas Galaxy Tab S4'");
						$_sql->execute();
	...
	<?php }?>
    	...
    	<?php 
						$_getAval = $_pdo->prepare("SELECT * FROM avalia_prods WHERE prod_aval = 'Tablet 10.5 Polegadas Galaxy Tab S4'");
						$_getAval->execute();
						$_getAvalFetch = $_getAval->fetchAll(PDO::FETCH_ASSOC);

							$_getAvalAverage = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Tablet 10.5 Polegadas Galaxy Tab S4'");

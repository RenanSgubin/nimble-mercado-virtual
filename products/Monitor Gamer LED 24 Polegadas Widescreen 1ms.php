<?php session_start();?>
		...
		<html>
		 <head>
		 	<title>Monitor Gamer LED 24 Polegadas Widescreen 1ms 144hz Hero</title>
   ...
   <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
		 ...
		 <body>
		  <?php require_once('../php/nav.php');?>
			...
			<div id='container-item'>
				<div id='div-img-left'>
					<div id='div-extra-imgs'>
						<img src='../imgsextra/ca5e28de9ca9ece2f45de046ca5ad23c.jpg' class='extra-imgs' id='imgextra0' onclick='iimgextra1()'><br>
						<img src='../imgsextra/0c552b4aba3f5289544ae322693ea77f.png' class='extra-imgs' id='imgextra1' onclick='iimgextra2()'><br>
						<img src='../imgsextra/b9acc275b7ae1942f4b51c159ea57608.jpg' class='extra-imgs' id='imgextra2' onclick='iimgextra3()'><br>
						<img src='../imgsextra/334fa6ee881d7b674144ab4d2a9de406.jpg' class='extra-imgs' id='imgextra3' onclick='iimgextra4()'>
					</div>
					<img src='../upload/0adf51f142ba37969ea41f4a0e60566c.jpg' id='img-left'>
				</div>
				<div id='div-infos-product'>
					<b id='title'>Monitor Gamer LED 24 Polegadas Widescreen 1ms 144hz Hero</b><br>
					<div id='evaluation' style='position: relative; height: 1.3vw;'>
						...
						<?php
											...
											$_selectAll = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Monitor Gamer LED 24 Polegadas Widescreen 1ms 144hz Hero'");
											$_selectAll->execute();
	 				 ...
	 				 <b id='price'>R$ 1709<br><b style='font-size: 17px;'>Ou 5x de R$ 341,80</b><br></b><br>
	 				  
					<form method='post' action='../inserts/insertCarrinho?np=<?php echo 'Monitor Gamer LED 24 Polegadas Widescreen 1ms 144hz Hero';?>'>
			...
			<div id='desc-prod'>
				...
				<div id='alig-desc'>Monitor Gamer LED 24 Polegadas Widescreen 1ms 144hz Hero </div>
			</div><br><br>
			...
			<div id='features-prod-b'><b>Características Gerais</b></div><br>
				...
				<?php
						...
						$_sql = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Monitor Gamer LED 24 Polegadas Widescreen 1ms 144hz Hero'");
						$_sql->execute();
	...
	<?php }?>
    	...
    	<?php 
						$_getAval = $_pdo->prepare("SELECT * FROM avalia_prods WHERE prod_aval = 'Monitor Gamer LED 24 Polegadas Widescreen 1ms 144hz Hero'");
						$_getAval->execute();
						$_getAvalFetch = $_getAval->fetchAll(PDO::FETCH_ASSOC);

							$_getAvalAverage = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Monitor Gamer LED 24 Polegadas Widescreen 1ms 144hz Hero'");

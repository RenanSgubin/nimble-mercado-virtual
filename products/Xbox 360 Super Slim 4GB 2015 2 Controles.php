<?php session_start();?>
		...
		<html>
		 <head>
		 	<title>Xbox 360 Super Slim 4GB 2015 2 Controles</title>
   ...
   <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
		  ...
		  <?php require_once('../php/nav.php');?>
			...
			<div id='container-item'>
				<div id='div-img-left'>
					<div id='div-extra-imgs'>
						<img src='../imgsextra/d1f78483d42a621c9c87a8d1569c6ae0.png' class='extra-imgs' id='imgextra0' onclick='iimgextra1()'><br>
						<img src='../imgsextra/fbed4a2951faff8316e9b24d51e534d5.png' class='extra-imgs' id='imgextra1' onclick='iimgextra2()'><br>
						<img src='../imgsextra/d8f722cd826d7dc46ca302c79d708d19.jpg' class='extra-imgs' id='imgextra2' onclick='iimgextra3()'><br>
						<img src='../imgsextra/3d88d4f41babfe08ee9db19fc61008d1.jpg' class='extra-imgs' id='imgextra3' onclick='iimgextra4()'>
					</div>
					<img src='../upload/fdff902dc2e7cac2a89b53cce11da2f2.jpg' id='img-left'>
				</div>
				<div id='div-infos-product'>
					<b id='title'>Xbox 360 Super Slim 4GB 2015 2 Controles</b><br>
					<div id='evaluation' style='position: relative; height: 1.3vw;'>
						...
						<?php
											...
											$_selectAll = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Xbox 360 Super Slim 4GB 2015 2 Controles'");
											$_selectAll->execute();
					...
					<form method='post' action='../inserts/insertCarrinho?np=<?php echo 'Xbox 360 Super Slim 4GB 2015 2 Controles';?>'>
			...
			<div id='features-prod-b'><b>Características Gerais</b></div><br>
				...
				<?php
						...
						$_sql = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Xbox 360 Super Slim 4GB 2015 2 Controles'");
						$_sql->execute();
	...
	<?php }?>
    	...
    	<?php 
						$_getAval = $_pdo->prepare("SELECT * FROM avalia_prods WHERE prod_aval = 'Xbox 360 Super Slim 4GB 2015 2 Controles'");
						$_getAval->execute();
						$_getAvalFetch = $_getAval->fetchAll(PDO::FETCH_ASSOC);

							$_getAvalAverage = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Xbox 360 Super Slim 4GB 2015 2 Controles'");

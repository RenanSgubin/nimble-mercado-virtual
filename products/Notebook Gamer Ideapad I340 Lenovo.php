<?php session_start();?>
		...
		<html>
		 <head>
		 	<title>Notebook Gamer Ideapad I340 Lenovo</title>
   ...
   <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
		 ...
		 <body>
		  <?php require_once('../php/nav.php');?>
			...
			<div id='container-item'>
				<div id='div-img-left'>
					<div id='div-extra-imgs'>
						<img src='../imgsextra/91b4f705371c6d32d311656598ea5025.png' class='extra-imgs' id='imgextra0' onclick='iimgextra1()'><br>
						<img src='../imgsextra/c1b758f1301ac495c06d1b4c79afdbfb.png' class='extra-imgs' id='imgextra1' onclick='iimgextra2()'><br>
						<img src='../imgsextra/4ce51a0a7f7a93c52f2ea291896a7f96.jpg' class='extra-imgs' id='imgextra2' onclick='iimgextra3()'><br>
						<img src='../imgsextra/a143c2e301dc5d71ad74c6c6de309a92.jpg' class='extra-imgs' id='imgextra3' onclick='iimgextra4()'>
					</div>
					<img src='../upload/b933c60cd1b5ff052db632f01dcb805f.jpg' id='img-left'>
				</div>
				<div id='div-infos-product'>
					<b id='title'>Notebook Gamer Ideapad I340 Lenovo</b><br>
					<div id='evaluation' style='position: relative; height: 1.3vw;'>
						...
						<?php
											...
											$_selectAll = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Notebook Gamer Ideapad I340 Lenovo'");
											$_selectAll->execute();
	 				 ...
	 				 <b id='price'><h2 style='color: gray; text-decoration: line-through; font-size: 20px;'>R$ 3.300,00</h2><h2 id='price-real-confirm'> R$ 3.102,00</h2><b style='font-size: 18px;'>Ou 10x de R$ 310,20</b><br></b><br>
	 				  
					<form method='post' action='../inserts/insertCarrinho?np=<?php echo 'Notebook Gamer Ideapad I340 Lenovo';?>'>
			...
			<div id='desc-prod'>
				...
				<div id='alig-desc'>Notebook Gamer Ideapad I340 Lenovo </div>
			</div><br><br>
			...
			<div id='features-prod-b'><b>Características Gerais</b></div><br>
				...
				<?php
						...
						$_sql = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Notebook Gamer Ideapad I340 Lenovo'");
						$_sql->execute();
	...
	<?php }?>
    	...
    	<?php 
						$_getAval = $_pdo->prepare("SELECT * FROM avalia_prods WHERE prod_aval = 'Notebook Gamer Ideapad I340 Lenovo'");
						$_getAval->execute();
						$_getAvalFetch = $_getAval->fetchAll(PDO::FETCH_ASSOC);

							$_getAvalAverage = $_pdo->prepare("SELECT * FROM produtos WHERE Nome_Produto = 'Notebook Gamer Ideapad I340 Lenovo'");

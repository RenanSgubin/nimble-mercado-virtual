...
<html lang="en">
  ...
  <?php include "../php/nav.php"?>
   <div id="container-categories-promo">
   	<?php
					require_once("../conexao/db.php");
					$queryBD = $_pdo->prepare("SELECT * FROM produtos WHERE oferta = 'Sim'");
					$queryBD->execute();
   ...
   <script>
		   function changeLinkEffect(){
						document.getElementById("promo-a").style.borderBottom = "3px solid #e86332";
						document.getElementsByTagName("h6")[5].style.color = "#e86332";
			}

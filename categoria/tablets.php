   ...
   <div id="container-categories">
    <div class="content-filter-categories">
   	...
   	<?php
					...
					$queryBD = $_pdo->prepare("SELECT * FROM produtos WHERE Tipo_Produto = 'Tablet'");
					$queryBD->execute();
      ...
      <?php
		...
		<script>
			function changeLinkEffect(){
						document.getElementById("cel-a").style.borderBottom = "3px solid #e86332";
				  document.getElementsByTagName("h6")[0].style.color = "#e86332";
			}
